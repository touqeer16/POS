            ...
            @component('components.filters', ['title' => __('report.filters')])
              {!! Form::open(['url' => action('ReportController@getStockReport'), 'method' => 'get', 'id' => 'product_sell_report_form' ]) !!}
                ...
                <div class="col-md-3">
                 ...
                 <div class="col-md-3">
                    <div class="form-group">
                          {!! Form::label('product_sell_category_id', __('product.category') . ':') !!}
                         <div class="input-group">
                            <span class="input-group-addon">
                                <i class="fa fa-map-marker"></i>
                            </span>
                           {!! Form::select('product_sell_category_id', $categories, null, ['class' => 'form-control select2', 'placeholder' => __('lang_v1.all')]); !!}
                        </div>
                    </div>
                </div>
                {!! Form::close() !!}
            ...
            <div class="nav-tabs-custom">
                <ul class="nav nav-tabs">
                    ...
                    <li>
                     ...
                     <li>
                        <a href="#psr_grouped_branch_by_branch_tab" data-toggle="tab" aria-expanded="true"><i class="fa fa-bars" aria-hidden="true"></i> @lang('lang_v1.branch')</a>
                    </li>

                     <li>
                        <a href="#psr_category_grouped_branch_by_branch_tab" data-toggle="tab" aria-expanded="true"><i class="fa fa-bars" aria-hidden="true"></i> @lang('category.category')</a>
                    </li>
                ...
                <div class="tab-content">
                    ...
                    <!-- Show product count branch by branch -->

                    <div class="tab-pane" id="psr_grouped_branch_by_branch_tab">
                        <div class="table-responsive">
                            <table class="table table-bordered table-striped"
                            id="product_sell_grouped_branch_by_branch_report_table" style="width: 100%;">
                                <thead>
                                    <tr>
                                        <th>@lang('sale.product')</th>
                                        <th>@lang('product.sku')</th>
                                ...
                                <tfoot>
                                    <tr class="bg-gray font-17 footer-total text-center">
                                        <td colspan="5"><strong>@lang('sale.total'):</strong></td>
                                        <td id="footer_total_grouped_branch_branch_sold"></td>
                                        <td><span class="display_currency" id="footer_grouped_branch_by_branch_subtotal" data-currency_symbol ="true"></span></td>
                                    </tr>
                                </tfoot>
                            </table>
                        </div>
                    ...
                    <!-- Show category  count branch by branch -->

                    <div class="tab-pane" id="psr_category_grouped_branch_by_branch_tab">
                        <div class="table-responsive">
                            <table class="table table-bordered table-striped"
                            id="category_sell_grouped_branch_by_branch_report_table" style="width: 100%;">
                                <thead>
                                    <tr>
                                ...
                                <tfoot>
                                    <tr class="bg-gray font-17 footer-total text-center">
                                        ...
                                        <td id="footer_category_total_grouped_branch_branch_sold"></td>
                                        <td><span class="display_currency" id="footer_category_grouped_branch_by_branch_subtotal" data-currency_symbol ="true"></span></td>
                                    </tr>
                                </tfoot>
                            </table>
                        </div>
