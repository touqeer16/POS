<div class="row">
	...
	<div class="col-md-4 invisible"> <!-- invisible -->
	...
	<div class="col-md-8">
		...
		<div class="form-group invisible"> <!-- invisible -->
			<div class="input-group">
...
@endif
<div class="row">
	<div class="col-sm-12 pos_product_div" style="margin-top:-50px;"> <!-- style added to remove the block -->
