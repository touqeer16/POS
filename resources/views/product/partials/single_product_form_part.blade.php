        ...
        <tr>
          ...
          <td>
            <div class="col-sm-6">
              ...
              {!! Form::text('single_dpp', $default, ['class' => 'form-control input-sm dpp input_number', 'readonly'=> 'true', 'style'=>'border: none',  'placeholder' => __('product.exc_of_tax')]); !!}
            </div>
            ...
            <div class="col-sm-6">
              ...
              {!! Form::text('applicable_tax', $default, ['class' => 'form-control input-sm  input_number',  'readonly'=> 'true', 'style'=>'border: none', 'placeholder' => __('product.applicable_tax')]); !!}
            </div>
          </td>
          @if(empty($quick_add))
{{--          <td>--}}
