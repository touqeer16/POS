  ...
  <div class="modal-content">
    ...
    <div class="modal-body">
      ...
      <div class="form-group">
        ...
        {!! Form::number('short_code', $category->short_code, ['class' => 'form-control', 'placeholder' => $cat_code_label]); !!}
      ...
      <div class="col-md-6 col-lg-6 col-sm-12">
        <div class="form-group">
          {!! Form::label('category_image', __('messages.category_image') . ':') !!}
          {!! Form::file('image', ['id' => 'edit_upload_image', 'accept' => 'image/*']); !!}
          ...
          <div class="form-group">
            <div class="img-thumbnail">
              @if(!empty($category->image_path))
                <span class="badge bg-red delete-category-media" data-href="{{ action('TaxonomyController@deleteCategoryMedia', ['media_id' => $category->media->id])}}">
                 <i class="fa fa-close"></i>
                </span>
              @endif
              <img src="{{ $category->image_url }}" class="display-thumbnail" width="60" height="60" id="editCategoryImagePreview" />
            </div>
          </div>
        </div>
      </div>
