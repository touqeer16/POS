  ...
  <div class="modal-content">
    ...
    <div class="modal-body">
      ...
      <div class="form-group">
        ...
        {!! Form::number('short_code', null, ['class' => 'form-control', 'placeholder' => $cat_code_label]); !!}
      ...
      <div class="row">
        ...
        <div class="col-md-6 col-lg-6 col-sm-12">
          <div class="form-group">
              <img src="" class="thumbnail img-thumbnail" id="categoryImagePreview" style="display: none;">
          </div>
        </div>
      </div>
