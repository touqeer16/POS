...
const Table = (props) => {
    const { fetchTableData, tables, onSelectTable, tableId, selectedLocationId } = props;
...
export default connect(mapStateToProps, { fetchTableData, fetchTableDataFromIndexDB })(Table);
