...
class BusinessLocation extends Model
{
    ...
    public static function forDropdownReport($business_id, $show_all = false, $receipt_printer_type_attribute = false, $append_id = true, $check_permission = true)
    {
        $query = BusinessLocation::where('business_id', $business_id)->Active();
...
/*                 DB::raw("IF(location_id IS NULL OR location_id='', name, CONCAT(name, ' (', location_id, ')')) AS name"), */
    ...
    {
        return $this->hasMany(KitchenStation::class, 'business_location_id', 'id');
    }
}
