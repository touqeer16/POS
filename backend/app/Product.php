...
class Product extends Model
{
    ...
    */
    ...
    public function kitchenStation(){
        return $this->belongsTo(KitchenStation::class,'business_location_id','kitchen_station_id');
    }
    
    public function productKitchenStation(){
        return $this->belongsToMany(KitchenStation::class,'product_kitchen_stations','product_id','kitchen_station_id');
    }
}
