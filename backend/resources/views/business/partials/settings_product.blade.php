<div class="pos-tab-content">
    ...
    <div class="row">
        ...
        {{-- weight and Enable Product description, IMEI or Serial Number--}}
        <div class="col-sm-4">
            <div class="form-group">
                <div class="checkbox">
                    <label>
                        {!! Form::checkbox('enable_weight', 1, $business->enable_weight, [ 'class' => 'input-icheck']); !!} {{ __( 'messages.enable_weight' ) }}
                    </label>
                </div>
            </div>
        </div>
        ...
        <div class="col-sm-4">
            <div class="form-group">
                <div class="checkbox">
                    <label>
                        {!! Form::checkbox('enable_product_description_imei_or_serial_number', 1, $business->enable_product_description_imei_or_serial_number, [ 'class' => 'input-icheck']); !!} {{ __( 'messages.enable_product_description_imei_or_serial_number' ) }}
                    </label>
                </div>
            </div>
        </div>
