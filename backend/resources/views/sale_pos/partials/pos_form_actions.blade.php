...
@endphp
<div class="row">
    <div class="pos-form-actions " style="max-width:58.33333333%">
...
-->
        ...
        <div class="col-md-4" style="">
            <div class="col-lg-12" style="text-align: center;">
                <div class="btn-group-vertical ml-4 mt-4" role="group" aria-label="Basic example" style="margin-right: 10px;">
                    <div class="btn-group" style="display: flex;margin-bottom: 5px;">

                        <input class="text-center form-control-lg mb-2" id="code" style="border: none;" placeholder="QTY">
                    </div>
                    <div class="btn-group cal-border-bottom" style="display: flex;">
                        <button type="button" class="btn btn-outline-secondary py-3 cal-border-right" onclick="document.getElementById('code').value=document.getElementById('code').value + '1';">1</button>
                        <button type="button" class="btn btn-outline-secondary py-3 cal-border-right" onclick="document.getElementById('code').value=document.getElementById('code').value + '2';">2</button>
                    ...
                    <div class="btn-group cal-border-bottom" style="display: flex;">
                        <button type="button" class="btn btn-outline-secondary py-3 cal-border-right" onclick="document.getElementById('code').value=document.getElementById('code').value + '4';">4</button>
                        <button type="button" class="btn btn-outline-secondary py-3 cal-border-right" onclick="document.getElementById('code').value=document.getElementById('code').value + '5';">5</button>
                    ...
                    <div class="btn-group cal-border-bottom" style="display: flex;">
                        <button type="button" class="btn btn-outline-secondary py-3 cal-border-right" onclick="document.getElementById('code').value=document.getElementById('code').value + '7';">7</button>
                        <button type="button" class="btn btn-outline-secondary py-3 cal-border-right" onclick="document.getElementById('code').value=document.getElementById('code').value + '8';">8</button>
                    ...
                    <div class="btn-group" style="display: flex;">
                        <button type="button"  id="calculatorButton" class="btn btn-primary py-3" onclick="">Go</button>
                        <button type="button" class="btn btn-outline-secondary py-3 cal-border-right" onclick="document.getElementById('code').value=document.getElementById('code').value + '0';">0</button>
                        <button type="button" class="btn btn-outline-secondary py-3 calculatorClearButton" onclick="document.getElementById('code').value=document.getElementById('code').value.slice(0, -1);"><i class="fa fa-backspace"></i></button>
                    </div>
                </div>
            </div>
        </div>
