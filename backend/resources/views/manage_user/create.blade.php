        ...
        <div class="col-md-9">
          <div class="col-md-5">
            ...
            <div class="col-sm-4" style="margin-bottom: -35px;">
                <div class="form-group">
                    {!! Form::label('kitchen_station', __( 'messages.kitchen_station' ).' :') !!}
                    {!! Form::select('kitchen_station_id', [], null, ['class' => 'form-control select2','id' => 'kitchenStation','placeholder' => __('lang_v1.none'),'disabled']); !!}
                </div>
            </div>
            @endif
