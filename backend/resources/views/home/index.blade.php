...
<section class="content-header content-header-custom">
    ...
    <input type="hidden" id="termsConditionNotDone" value={{$termsConditionNotDoneStatus}} />
</section>
<!-- Main content -->
<section class="content content-custom no-print">
    ...
    <div class="row">
        ...
        <div class="col-md-4 col-xs-12">
            ...
            {!! Form::select('dashboard_location', $all_locations, null, ['class' => 'form-control select2',
            'placeholder' => __('lang_v1.select_location'), 'id' => 'dashboard_location']); !!}
            @endif
        </div>
        <div class="col-md-8 col-xs-12">
            <div class="btn-group pull-right" data-toggle="buttons">
                <label class="btn btn-info active">
                    <input type="radio" name="date-filter" data-start="{{ $date_filters['yesterday'] }}"
                        data-end="{{ $date_filters['yesterday'] }}" checked>{{ __('home.yesterday') }}
                </label>
                <label class="btn btn-info active">
    ...
    <div class="row">
        <div class="col-sm-12">
            ...
            @component('components.widget', ['class' => 'box-primary', 'title' => __('home.sells_last_07_days')])
    ...
    <div class="row">
        <div
            class="@if((session('business.enable_product_expiry') != 1) && auth()->user()->can('stock_report.view')) col-sm-12 @else col-sm-6 @endif">
            @component('components.widget', ['class' => 'box-warning'])
            @slot('icon')
            <i class="fa fa-exclamation-triangle text-yellow" aria-hidden="true"></i>
            @endslot
