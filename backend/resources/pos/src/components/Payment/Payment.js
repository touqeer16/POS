                    ...
                    <table class="m-auto" style={{ "width": "auto" }}>
                        <tbody>
                            <tr>
                                ...
                                <th class="text-center border-2 border-dark">Order# {paymentPrint.call_no}</th>
                            </tr>
                        </tbody>
                    </table>
...
const loadQrCode = (paymentPrint, allModifierTax, totalProductTax, user) => {
    ...
    let VATNumber = "310099050100003";  //user.tax_number_1; //"310099050100003";

    let businessName = "Shawerma Elak";  //user.business_name; //"Shawerma Elak";
